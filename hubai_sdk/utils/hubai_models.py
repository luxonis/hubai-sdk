...
#   timestamp: 2026-06-02T15:00:07+00:00
...
class EnumSampleSplitType(Enum):
    TRAIN = "TRAIN"
    VAL = "VAL"
    TEST = "TEST"
...
class ModelInstanceFileResponse(BaseModel):
    ...
    team_id: Annotated[
        UUID, Field(description="Hub team ID.", title="Team Id")
    ]
    user_id: Annotated[
        UUID, Field(description="Hub user ID.", title="User Id")
    ]
    created: Annotated[
        NaiveDatetime,
...
class ModelResponse(BaseModel):
    ...
    team_id: Annotated[
        UUID | None,
        Field(
            description="Hub team ID. Will be hidden/null for unauthenticated users.",
            title="Team Id",
        ),
    ]
    team_name: Annotated[
...
class RVC2ExportParametersOnnxIrPresetResponse(BaseModel):
    ...
    quantization_dataset_split: Annotated[
        EnumSampleSplitType | None,
        Field(
            description="Dataset split to use for quantization calibration data. Only applies when quantization_data is a dataset UUID."
        ),
    ] = EnumSampleSplitType.VAL
    inputs: Annotated[
...
class JobMessageResponse(BaseModel):
    ...
    steps: Annotated[
        list[JobStepResponse] | None,
        Field(
            description="For pipeline jobs: ordered list of all pipeline steps with their status. Null for non-pipeline jobs.",
            title="Steps",
        ),
    ] = None
